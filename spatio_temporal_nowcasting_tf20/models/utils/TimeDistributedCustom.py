...
class Wrapper2(Layer):
  ...
  def get_config(self):
    ...
    base_config = super(Wrapper2, self).get_config()
...
class TimeDistributedCustom(Wrapper2):
  ...
  def __init__(self, layer, **kwargs):
    ...
    super(TimeDistributedCustom, self).__init__(layer, **kwargs)
  ...
  def build(self, input_shape):
    ...
    super(TimeDistributedCustom, self).build(tuple(child_input_shape))
    self.built = True
